...
class WavLMLarge(SpeechEncoder):
    def __init__(self, vec_path="pretrain/WavLM-Large.pt", device=None, output_layer=6):
        super().__init__()
    ...
    def encoder(self, wav):
        ...
        with torch.no_grad():
            with torch.inference_mode():
                units = self.model.extract_features(feats[None, :], output_layer=self.output_layer)[0]
